...
const Footer = () => {
  return (
    <div>
      <div className='flex flex-col items-center bg-[#0a00797d] pt-[1rem] mt-[5rem] w-full sm:h-[8rem]'>
       ...
       <div className='flex items-center'>
            ...
            <p className='text-[1rem] ml-1 text-white'>Pouyan jahanshahloo</p>
        </div>
        <div className='flex items-center'>
            <AiOutlineMail className='text-white' size={30}/>
            <p className='text-[1rem] ml-1 text-white'>pouyan150@gmail.com</p>
        </div>
        <div className='flex items-center'>
            <BsTelegram className='text-white' size={30}/>
            <p className='text-[1rem] text-white ml-1'>@Ipouyan</p>
        </div>
        <div className='flex items-center'>
            <AiFillGithub className='text-white' size={30}/>
            <p className='text-[1rem] text-white ml-1'>Pouyanjh</p>
        </div>
