...
const Navbar = ()=>{
    ...
    return(
        <div  className="nav flex fixed  justify-between items-center w-full  h-10 px-4 z-50 bg-gradient-to-b from-[#310dff] to-black">
            <h1 className="text-white font-['Lobster'] text-[1.5rem] z-50">POUYAN</h1>
            ...
            {Menu && (
            <ul className="w-full flex fixed justify-center capitalize items-center z-20 h-full flex-col  left-[50%] translate-x-[-50%] top-0 bg-gradient-to-b from-[#310dff] to-[#070707] ">
                {Links.map((items)=>{
                    return (
