...
const Media = ()=>{
    ...
    const Media = [
        ...
        },
        {
            ...
            name:'Linkdin',
            url: 'https://www.linkedin.com/in/pouyan-jahanshahloo-03774023a/'
        },
        {
            id : 3,
            icon : (
        ...
        <div>
            <div>
                <div className=" flex-col fixed z-10  sm:top-[47%] hidden md:top-[40%] sm:flex  md:flex">
                    ...
                    {Media.map((item)=>{
                        return <li  key={item.id}  className=' anime w-40 h-14 flex justify-center items-center ml-[-100px]  hover:ml-[-10px] px-4 duration-200 mb-2 rounded-md bg-[#25027cdf]'>
